...
# --- GESTIÓN DEL CARRITO (CON SOPORTE PARA SCROLL) ---
    ...
    if request.method == 'POST':
        ...
        if metodo == 'MP':
            try:
                ...
                preference_data = {"items": items_mp, "back_urls": {"success": request.build_absolute_uri('/'), "failure": request.build_absolute_uri('/'), "pending": request.build_absolute_uri('/')}, "auto_return": "approved", "binary_mode": True}
